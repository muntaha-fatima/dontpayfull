...
export default function Blog() {
  ...
  return (
    <div className="container mx-auto m-0">
      ...
      <div className="m-4 mt-8 sm:m-8 sm:mt-12">
  <footer className="bg-neutral-50 py-6 -mb-8">
    <nav className="flex  sm:flex-row sm:space-x-6 sm:justify-center sm:items-center">
      <a href="/support/home" className="text-gray-500 py-1 sm:px-4">
        Home /
      </a>
      <a href="/support/solutions" className="text-gray-500 py-1 sm:px-4">
        Solutions /
      </a>
      <a href="http://dontpayfull.com" className="text-gray-500 py-1 sm:px-4">
        Main Website /
      </a>
      <a href="http://forum.dontpayfull.com" className="text-gray-500 py-1 sm:px-4">
        Forum /
      </a>
      <a href="http://blog.dontpayfull.com" className="text-gray-500 py-1 sm:px-4">
        Blog
      </a>
    </nav>
  </footer>
